...
public class Shrink {
    ...
    @Test
    public void shrinksuccessful() throws UiObjectNotFoundException, InterruptedException {
        ...
        Thread.sleep(1000);
        UiObject shrink = device.findObject(new UiSelector().resourceId("com.google.blockly.demo:id/blockly_zoom_out_button"));
        shrink.click();
    }
}
