...
public class Magnify {
    ...
    @Test
    public void magnifysuccessful() throws UiObjectNotFoundException, InterruptedException {
        ...
        Thread.sleep(1000);
        UiObject magnify = device.findObject(new UiSelector().resourceId("com.google.blockly.demo:id/blockly_zoom_in_button"));
        magnify.click();
    }
}
