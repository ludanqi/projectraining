...
public class Run {
    ...
    @Test
    public void runsuccessful() throws UiObjectNotFoundException, InterruptedException {
        ...
        Thread.sleep(1000);
        UiObject run = device.findObject(new UiSelector().resourceId("com.google.blockly.demo:id/btn_run"));
        run.click();
    }
}
